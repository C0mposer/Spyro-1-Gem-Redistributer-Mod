...
enum GameStates
{
    ...
    GAMESTATE_FLIGHT_LEVEL_COMPLETE = 0x7,
...
//Drawing Functions
int DrawTextCapitals(char *text, int *TextInfo, int spacing, char color);                               //? This function draws text with all capitcal letters.
...
void DrawMobys();
void RenderObjs();
void DrawShapePreReq(int param_1, int param_2, int param_3, short colorSpace, int param_5);
